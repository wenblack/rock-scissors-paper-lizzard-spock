    ...
    <section className="py-8 w-[80vw]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-8">
          <div className=" hover:opacity-70 hover:cursor-pointer bg-gray-100 flex flex-col gap-4 items-center justify-center  border-slate-300 shadow-lg hover:border-purple-600 py-4 px-2 xs:max-w-[160px] border rounded">
            <Image alt="Rock Image" className="bg-gray-100" src={rockImg} width={60} height={60}></Image>
          </div>
          <div className=" bg-gray-100 hover:opacity-70 hover:cursor-pointer flex items-center justify-center  border-slate-300 shadow-lg hover:border-purple-600 py-4 px-2 xs:max-w-[160px] border rounded">
            <Image alt="Paper Image" className="bg-gray-100" src={paperImg} width={60} height={60}></Image>
          </div>
          <div className=" hover:opacity-70 hover:cursor-pointer flex bg-gray-100 items-center justify-center  border-slate-300 shadow-lg hover:border-purple-600 py-4 px-2 xs:max-w-[160px] border rounded">
